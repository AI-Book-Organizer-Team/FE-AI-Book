...
import com.example.fe_ai_book.DirectSearchActivity;
...
public class MyBookFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // ✅ 검색 버튼 → DirectSearchActivity 실행
        searchIcon.setOnClickListener(v -> {
            String keyword = searchBox.getText().toString().trim();
            Intent intent = new Intent(requireContext(), DirectSearchActivity.class);
            intent.putExtra("search_query", keyword); // 검색어 전달
